<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortfolioEdit.aspx.cs" Inherits="Admin_PortfolioEdit"  ValidateRequest="false"%>
    ...
    <form id="form1" runat="server">
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Portfolio - Edit</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtSiteLink" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
